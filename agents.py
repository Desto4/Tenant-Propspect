...
Step 1 — Call find_best_leads once with the keyword and location the user specified. This pulls from Google Maps, Yelp, Reddit, and Perplexity in parallel, merges duplicates, ranks by quality signals, and for Florida locations automatically runs Florida Sunbiz (Division of Corporations) on each ranked lead. Do not call it multiple times for the same request.
